...
$VIVADO_IMAGE = if ($env:VIVADO_IMAGE) {$env:VIVADO_IMAGE} else {"kosmos-vivado:2018.3"}
$LICENSE_MAC = if ($env:LICENSE_MAC) {$env:LICENSE_MAC} else {"74:78:27:3f:08:c3"}
...
Write-Host "VIVADO_IMAGE: $VIVADO_IMAGE"
